...
register(
    ReportDefinition(
        ...
        subject=N_("[ETD] Executive summary - {tenant} - {period}"),
        category="overview",
        icon="chart",
...
register(
    ReportDefinition(
        ...
        subject=N_("[ETD] Compromise indicators - {tenant} - {period}"),
        category="threats",
        icon="alert",
...
register(
    ReportDefinition(
        ...
        subject=N_("[ETD] Health check - {tenant} - {period}"),
        category="operations",
        icon="pulse",
...
register(
    ReportDefinition(
        ...
        subject=N_("[ETD] Very Attacked People - {tenant} - {period}"),
        category="threats",
        icon="target",
...
register(
    ReportDefinition(
        ...
        subject=N_("[ETD] Campaigns - {tenant} - {period}"),
        category="threats",
        icon="layers",
...
register(
    ReportDefinition(
        key="exposure",
        name=N_("Exposure and dwell time"),
        ...
        subject=N_("[ETD] Exposure and dwell time - {tenant} - {period}"),
        category="risk",
        icon="clock",
...
register(
    ReportDefinition(
        key="techniques",
        name=N_("Techniques and business risk"),
        ...
        subject=N_("[ETD] Techniques and business risk - {tenant} - {period}"),
        category="threats",
        icon="crosshair",
...
register(
    ReportDefinition(
        ...
        subject=N_("[ETD] Vendor risk - {tenant} - {period}"),
        category="risk",
        icon="briefcase",
...
register(
    ReportDefinition(
        key="auth_posture",
        name=N_("Authentication posture"),
        ...
        subject=N_("[ETD] Authentication posture - {tenant} - {period}"),
        category="risk",
        icon="lock",
...
register(
    ReportDefinition(
        ...
        subject=N_("[ETD] Audit and compliance - {tenant} - {period}"),
        category="operations",
        icon="clipboard",
...
register(
    ReportDefinition(
        ...
        name=N_("Posture and effectiveness"),
        ...
        subject=N_("[ETD] Posture and effectiveness - {tenant} - {period}"),
        category="overview",
        icon="gauge",
...
register(
    ReportDefinition(
        ...
        subject=N_("[ETD] Cross-tenant roll-up - {period}"),
        category="overview",
        icon="grid",
